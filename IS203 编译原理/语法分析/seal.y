...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    // %type <variableDecls> op_variableDecl_list
...
%%
    ...
    program		: decl_list {
     ...
     decl_list : decl     /* single declare */
    { $$ = single_Decls($1); }
    | decl_list decl  /* several declares */
    ...
    variableDecl_list : variableDecl     /* single declare */
    { $$ = single_VariableDecls ($1); }
    | variableDecl_list variableDecl  /* several declares */
